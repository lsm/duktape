...
#undef DUK__FUN_LOCAL  /* performance is slightly better without a local 'fun': https://github.com/svaarala/duktape/pull/370 */
#if defined(DUK__FUN_LOCAL)
#define DUK__FUN()          fun
#else
